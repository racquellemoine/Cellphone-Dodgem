...
class PlayerState:
    def __init__(self, id, name, color, initial_pos_x, initial_pos_y, stalls_to_visit, T_theta, tsp_path):
        self.id = id
        self.name = name
        self.color = color
        ...
        # log file
        self.log = os.path.join("logs", "player " + str(id) + " team " + str(name) + ".txt")
